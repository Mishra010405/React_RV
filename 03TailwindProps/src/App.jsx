...
<br/>
<div class="bg-gray-50 block max-w-sm border border-default rounded-base shadow-xs">
    <a href="#">
    ...
    <div class="p-6 text-center">
        ...
        <a href="#">
            <h5 class="mt-3 mb-6 text-2xl font-semibold tracking-tight text-heading text-black">Streamlining your design process today.</h5>
        </a>
        <a href="#" class="inline-flex items-center text-white bg-brand box-border border border-transparent hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none text-black">
            Read more
